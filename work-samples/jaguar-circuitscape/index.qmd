...
::: {layout-ncol="2"}
![*Land Cover Type in Barrier Centers for Jaguars in the Talamanca-Osa Region.* Dominant land covers, with Secondary and Primary Forests, Grassland Pasture, and Palm Plantations as key barriers between protected areas in southern Costa Rica.](fig1.png)

![*Land cover types within barrier patches.* Pixels represent land cover types within the habitat connectivity barrier patches between habitat centers.](fig2.png)
:::
